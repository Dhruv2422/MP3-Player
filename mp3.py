...
class MusicPlayer():
    def __init__(self,root):
        ...
        playbtn = Button(buttonframe,text="RESUME",command=self.resumesong,width=10,height=1,font=("times new roman",16,"bold"),fg="navyblue",bg="pink").grid(row=0,column=2,padx=10,pady=5)
...
root = Tk() #initializing the tkinter class 
MusicPlayer(root) #initializing the MusicPlayer class we created
root.mainloop()